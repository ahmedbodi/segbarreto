...
tagBits = tagBits / 8;
		...
		// Implementacao do Algoritmo 1, na página 4 do artigo
	...
	/**
	 * Seta o valor unitário à direita de uma string de sequência binária
	 * @param input
	 * @return output
	 */
	...
	/**
	 * O valor unitário da sequência de bits é colocado na posição de maior ordenação
	 * @param input
	 * @return output
	 */
