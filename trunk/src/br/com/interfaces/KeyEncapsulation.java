...
public interface KeyEncapsulation {
	 ...
	 * @param sr the chosen sponge-based PRG.
	 */
	void setup(BigInteger p, BigInteger q, BigInteger g1, BigInteger g2, HashFunction H, SpongePRG sr);
